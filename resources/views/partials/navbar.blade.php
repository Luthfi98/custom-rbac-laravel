...
<div class="nav-header">
    <a href="{{ route('dashboard.index') }}" class="brand-logo">
        <img src="{{ url($general->getSetting()->logo) }}" class="logo-abbr" width="32" height="30" alt="">
        ...
        <span style="font-size: 12px" class="brand-title text-white">{{ $general->getSetting()->name }}</span>
